...
def totals_tree(m):
    ...
    "*** YOUR CODE HERE ***"
    if is_mobile(m):
        # Create a tree that has left and right children
...
def replace_thor_at_leaf(t, thors_replacement):
    ...
    if is_leaf(t) and label(t) == "thor":
        ...
        return tree(label(t), [replace_thor_at_leaf(branch, thors_replacement) for branch in branches(t)])
